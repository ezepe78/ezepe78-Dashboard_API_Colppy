...
import { SyncMetadata } from '@/types/dashboard';

export function DataStatus({ metadata }: { metadata?: SyncMetadata }) {
  ...
  async function syncNow() {
    ...
    try {
      ...
      setMessage('No fue posible actualizar datos en este momento.');
    } finally {
      setLoading(false);
    }
  }
